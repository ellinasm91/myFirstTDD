...
public class StringCalculatorTest {
     ...
     */
    @Test
    public final void whenEmptyStringIsUsedReturnZero() {
        Assert.assertEquals(0, StringCalculator.Add(""));
    }

    @Test
    public final void whenOneNumberResultIsThatNumber() {
        Assert.assertEquals(1, StringCalculator.Add("1"));
    }

    @Test
    public final void whenTwoNumbersThenResultIsTheirSum() {
        Assert.assertEquals(3, StringCalculator.Add("1,2"));
        Assert.assertEquals(-2, StringCalculator.Add("-4,2"));
    }
